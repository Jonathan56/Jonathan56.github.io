...
c.MarkdownExporter.template_path = ['/home/jonathan/.ipython/templates'] # point this to your jekyll template file
...
def path2support(path):
    ...
    return '/home/jonathan/Desktop/images/' + os.path.basename(path)

c.MarkdownExporter.filters = {'path2support': path2support}

if f:
    c.NbConvertApp.output_base = f.lower().replace(' ', '-')
    c.FilesWriter.build_directory = '/home/jonathan/Desktop' # point this to your build directory
