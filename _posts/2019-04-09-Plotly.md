...
# Line plot
  ...
  '#1f77b4', rgba(55, 128, 191) // muted blue
  '#ff7f0e', rgb(255, 127, 14) // safety orange
  '#2ca02c', rgb(44, 160, 44) // cooked asparagus green
  '#d62728', rgb(214, 39, 40) // brick red
  '#9467bd', rgb(148, 103, 189) // muted purple
  '#8c564b', rgb(140, 86, 75) // chestnut brown
  '#e377c2', rgb(227, 119, 194) // raspberry yogurt pink
  '#7f7f7f', rgb(127, 127, 127) // middle gray
  '#bcbd22', rgb(188, 189, 34) // curry yellow-green
  '#17becf' rgb(23, 190, 207)  // blue-teal
